...
<div class="top">
    ...
    <div class="search">
        <form action="${ctx}/queryProductList.action" method="post">
        ...
        <div class="car_bg">
            ...
            <ul class="cars">
                <c:forEach items="${sessionScope.cart.items}" var="temp">
                    <li>
                        <div class="img"><a href="${ctx}/Product?action=queryProductDeatil&id=${temp.product.id}"><img src="${ctx}/statics/files/${temp.product.fileName}" width="58" height="58" /></a></div>
            ...
            <c:if test="${sessionScope.loginUser==null}">
                <div class="price_a"><a href="${ctx}/toLogin.action">去登录</a></div>
            </c:if>
            <c:if test="${sessionScope.loginUser!=null}">
